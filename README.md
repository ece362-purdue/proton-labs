...
[OV7670 Camera with PIO, UVC and CDC over USB, and a Fruit Classifier](https://github.com/norandomtechie/proton-fruit-classifier/blob/main/README.md)
   - This was for a personal project that ended up being fairly well implemented by a Claude Opus 4.6 agentic model in April 2026.  Opus generated the "known" parts of the project, and created automated debugging scripts to help itself debug what went wrong using the serial port. 
